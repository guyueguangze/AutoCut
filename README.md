...
```powershell
python -m uv run autocut ocr-subtitles-adaptive "inputs/01 - 猴王初问世.flv" --ocr-engine ppocrv6 --ppocrv6-model-size tiny --output outputs/monkey_king.ppocrv6.subtitles.srt --transcript-output runs/monkey_king/ppocrv6.transcript.json
```
